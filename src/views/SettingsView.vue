      ...
      <AppCard>
        ...
        <dl class="space-y-3">
          ...
          <div class="flex items-center justify-between border-b border-divider pb-3">
            ...
            <dd class="whitespace-nowrap text-caption text-ink">sqlite:aprilio.db</dd>
          </div>
          <div class="flex items-center justify-between border-b border-divider pb-3">
            <dt class="whitespace-nowrap text-fine text-weak">学生 / 图片</dt>
            <dd class="whitespace-nowrap text-caption text-ink">{{ stats.students }} 条 / {{ stats.photos }} 张</dd>
          </div>
